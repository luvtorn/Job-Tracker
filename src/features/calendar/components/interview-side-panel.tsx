  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="fixed right-0 top-0 h-full w-full sm:w-96 bg-white border-l border-neutral-200 shadow-lg z-50 overflow-y-auto lg:relative lg:w-auto lg:h-auto lg:border-l-4 lg:border-l-blue-600 lg:shadow-none"
      >
        {/* Header */}
